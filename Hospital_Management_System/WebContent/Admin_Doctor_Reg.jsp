...
$(document).ready(function(){	
	...
	$("#userid").keyup(function(){
	      var doctorusername = $(this).val().trim();
	      ...
	      if(doctorusername != ''){
	         $.ajax({
	            url: 'Doctor',
	            type: 'post',	
	            data: {flag:username , doctorusername1:doctorusername},
		...
		<div class="container" style="margin-right: 90px;">
			<ul class="nav nav-tabs tabcalss">
				<li class="active" id="tab1doctorlist"><a href="#home"
					style="background-color: f1f4f9;"><i class="fa fa-bars"
						aria-hidden="true" style="border-radius: 50%; padding: 8px;"></i>Doctor list</a></li>
				<li id="tabdoctoradd"style="margin-left: 15px; background-color: f1f4f9;"><a 
					href="#menu1" id="doctortab1" ><i class="fa fa-plus-circle"
						aria-hidden="true" style="border-radius: 50%; padding: 8px;"></i>Add Doctor</a>
				</li>
			...
			<div id="home" class="tab-pane fade in active" style="margin-top: 10px;">
			        ...
			        <thead>
			            <tr>
			                <th>Photo</th>
							 <th style="padding-left: 15px;"> Doctor Name</th>
							 <th style="padding-left: 15px;">Department</th>
							 <th style="padding-left: 15px;"> Specialization</th>
							 <th style="padding-left: 15px;"> Degree</th>
			...
			<div id="menu1" class="tab-pane fade">
						...
						<div style="margin-top: 10px;">
							<div class="form-group row">
				  			...
				  			<div class="form-group row">
					    		...
					    		<label class="col-sm-2 text" for="birth_date">Date of birth<span style="color: red;">*</span></label>
								<div class="col-sm-4">
				  			...
				  			<div class="form-group row">
					    		...
					    		<div class="col-sm-4">
									...
									<label class="radio-inline"><input type="radio" name="gender" value="female"style="color: blue;">Female</label>
					    		</div>
				  			</div>
						</div>
					</div>
				...
				<div style="margin-top: 10px;">
					...
					<div class="form-group row">
			    		<label class="col-sm-2 col-form-label text" >Visiting Charges(&#x20B9;)<span style="color: red;">*</span></label>
			    		<div class="col-sm-4">
				    ...
				    <div class="form-group row" style="margin-top: -10px;">
			    		<label class="col-sm-2 col-form-label text" >consulting charge(&#x20B9;)<span style="color: red;">*</span></label>
			    		<div class="col-sm-4">
