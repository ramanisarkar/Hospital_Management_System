...
<c:forEach items="${sessionScope.hospitaldata }" var="q" end="0">
  ...
  <div class="tab" class="tab-pane fade">Name:
				...
				<div style="margin-top: 10px;">
				    <div class="form-group row">
			    	 ...
			    	 <div class="form-group row">
  					...
  					<div class="form-group row">
			    		<input class="btn btn-success" id="insertback2"  type="button" value="Save And Next Step"  style="margin-left: 195px; background-color: #22BAA0;">
  					</div>
				</div>
			</div>		
