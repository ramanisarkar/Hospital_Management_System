...
$(document).ready(function(){
	...
	var username="laboratoryStaffList";
		$.get('Laboratory',{flag:username},function(response) {
	...
	$("#txt_username").keyup(function(){
	      var laboratoryStaff = $(this).val().trim();
	      ...
	      if(pharmacist != ''){
	         $.ajax({
	            url: 'Laboratory',
	            type: 'post',
	            data: {flag:username , laboratoryStaffusername:laboratoryStaff},
	...
	$('#insert_form').on('submit' , function(event){
	    ...
	    $.ajax({
	        ...
	        success: function(response ,textStatus , jqXHR ){
	        	console.log(response);
	        	var obj = JSON.parse(response);
	        	if(obj[0].laboratoryupdate == "true"){
	        		$('#message1').show();
	        		$('#message2').show();
	        		$('#message3').show();
	        	...
	        	else if(obj[0].laboratoryemail == "false"){
	        		$('#message1').show();
	        		$('#message2').show();
	        		$('#message3').show();
	        	...
	        	else if(obj[0].laboratoryemailinvalid == "false"){
	        		$('#message1').show();
	        		$('#message2').show();
	        		$('#message3').show();
	...
	$(document).on('click', '.edit', function(){
		...
		console.log(editid);
		var laboratoryStaff = $('#laboratoryStaffId'+editid).val();
		var username = "editLaboratoryStaff";
		$.get('Laboratory',{flag:username , laboratoryStaffId:laboratoryStaff},function(response){
	...
	$(document).on('click', '.delete', function(){
		...
		var laboratoryStaff = $('#laboratoryStaffId'+deleteid).val();
		var username = "deleteLaboratoryStaff";
		$.get('Laboratory',{flag:username , laboratoryStaffId:laboratoryStaff},function(response){
 	...
 	$(".nav-tabs a").click(function(){
   		$("#laboratoryStaffListtab2").hide();
   		$('#message1').hide();
		$('#message2').hide();
		$('#message3').hide();
   	    $(this).tab('show');
   	    var laboratoryStaffList =  $(this).text(); 
   	    console.log(supportStaffList);
   	    if(laboratoryStaffList=="Laboratory Staff List"){
   	    	location.reload();
   	    }
   	});
});
		...
		<div class="container" style="margin-right: 90px;">
			<ul class="nav nav-tabs tabcalss">
				<li class="active" id="tab1doctorlist"><a href="#home"
					data-toggle="tab" ><i class="fa fa-bars"
						aria-hidden="true" style="border-radius: 50%; padding: 8px;"></i>Laboratory Staff List</a></li>
						
				<li id="tabdoctoradd"style="margin-left: 15px; background-color: f1f4f9;">
				<a href="#menu1" id="laboratoryStaffListtab1" data-toggle="tab">
				<i class="fa fa-plus-circle"aria-hidden="true" style="border-radius: 50%; padding: 8px;"></i>Add New Laboratory Staff</a>
				</li>
				<li id="tabdoctoradd"style="margin-left: 15px; background-color: f1f4f9;"><a 
				id="laboratoryStaffListtab2" data-toggle="tab"
			...
			<div id="home"  class="container tab-pane active"style="margin-top: 10px;">
			        ...
			        <thead>
			            <tr>
			            	<th>Photo</th>
							<th style="padding-left: 15px;">Laboratory Staff Name</th>
							<th style="padding-left: 15px;"> Laboratory Staff Email</th>
							<th style="padding-left: 15px;"> Mobile Number</th>
							<th style="padding-left: 15px;">Action</th>
			            </tr>
			        </thead>
			        <tbody class="laboratory">
				...
				<div style="margin-top: 10px;">
				    <div class="form-group row">
			    	 ...
			    	 <div class="form-group row">
			    		...
			    		<input type="hidden" id="laboratoryStaffId" name="laboratoryStaffId" >
