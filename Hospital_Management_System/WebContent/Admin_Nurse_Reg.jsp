...
$(document).ready(function(){
	...
	var count = 0;
	var username="nurselist";
		$.get('Nurse',{flag:username},function(response) {
			var obj = JSON.parse(response);
			$.each(obj, function(index, value) {
			count++;
		   	var html = '';
		   	html += '<tr id='+count+'>';
		   	html += '<td><img src="Nurse_Image/'+obj[index].profileimage+'" height="50px" width="50px" class="img-circle"></td>';
			...
			html += '<td><button style="margin-top: 10px;" type="button" class="btn btn-info  edit" data-edit_id="'+count+'" id="nurseid'+count+'" value="'+obj[index].id+'">Edit</button>';
			html += '<button style="margin-left: 10px; margin-top: 10px;" type="button" class="btn btn-danger delete" data-delete_id="'+count+'" id="nurseid'+count+'" value="'+obj[index].id+'">Delete</button></td></tr>';
			$('.nurse').append(html);
	 	});
			 $('#example').DataTable();
	});
	$("#txt_username").keyup(function(){
	      ...
	      var nurseusername = $(this).val().trim();
	      ...
	      if(nurseusername != ''){
	         $.ajax({
	            url: 'Nurse',
	            type: 'post',
	            data: {flag:username , nurseusername1:nurseusername},
	...
	$(document).on('click', '.edit', function(){
		...
		console.log(editid);
		var nurse = $('#nurseid'+editid).val();
		var username = "editNurse";
		$.get('Nurse',{flag:username , nurseid:nurse},function(response){
 			$("#nursetab1").hide();
 			var obj = JSON.parse(response);
			console.log(response);
			$("#nursetab2").show();
			$('.nav-tabs a[href="#menu2"]').tab('show');
			$('#nurseid').val(obj[0].id);
			...
			if(obj[0].profileimagename){
				...
				$("#coveredit").attr("src", "Nurse_Image/"+obj[0].profileimage+"");
			}else{
				$('#profileimageid').hide();
			}
		});
	...
	$(document).on('click', '.delete', function(){
		...
		var nurse = $('#nurseid'+deleteid).val();
		var username = "deleteNurse";
		$.get('Nurse',{flag:username , nurseid:nurse},function(response){
		...
		<div class="container" style="margin-right: 90px;">
			<ul class="nav nav-tabs tabcalss">
				<li class="active" id="tab1doctorlist"><a href="#home"
					data-toggle="tab" ><i class="fa fa-bars"
						aria-hidden="true" style="border-radius: 50%; padding: 8px;"></i>Nurse list</a></li>
						
				<li style="margin-left: 15px; background-color: f1f4f9;">
				<a href="#menu1" id="nursetab1" data-toggle="tab">
				<i class="fa fa-plus-circle"aria-hidden="true" style="border-radius: 50%; padding: 8px;"></i>Add New Nurse</a>
				</li>
				...
				id="nursetab2" data-toggle="tab"
					href="#menu2" style="display: none;"><i class="fas fa-edit"
						aria-hidden="true" style="border-radius: 50%; padding: 8px;"></i>Edit Nurse</a>
				</li>
			</ul>
			...
			<div id="home"  class="container tab-pane active"style="margin-top: 10px;">
			        ...
			        <thead>
			            <tr>
			                <th>Photo</th>
							 <th style="padding-left: 15px;"> Nurse Name</th>
			...
			<div id="menu1" class="tab-pane">
				  			...
				  			<div class="form-group row">
					    		...
					    		<div class="col-sm-4">
									<div class="input-group date" data-date-format="dd/mm/yyyy">
						            	<input  type="text" name="dob" id="dateofbarth" class="form-control" placeholder="dd/mm/yyyy"style="width: 361px;" required readonly>
				...
				<div style="margin-top: 10px;">
					<div class="form-group row">
			    		...
			    		<div class="col-sm-1">
			      			<input type="tel" class="form-control" name="standardcode" value="+91" readonly>
			    		</div>
			    		<div class="col-sm-3">
				...
				<div style="margin-top: 10px;">
					...
					<div class="form-group row">
			    		<label class="col-sm-2 col-form-label text" >Charges(&#x20B9;)<span style="color: red;">*</span></label>
			    		<div class="col-sm-4">
			...
			<div id="menu2" class="tab-pane">
				...
				<div style="margin-top: 10px;">
					...
					<div class="form-group row">
			    		<label class="col-sm-2 col-form-label text" >Charges(&#x20B9;)<span style="color: red;">*</span></label>
			    		<div class="col-sm-4">
			      			<input type="text" class="form-control"  id="chargeid" name="charge" required>
			    		</div>
			    		<div  class="form-group" style="margin-top: 10px;">
			      			<p>/ Per Day</p>
			    		</div>
