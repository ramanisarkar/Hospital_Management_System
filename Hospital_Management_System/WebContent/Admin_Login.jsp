...
<body style=" background-color :#f1f4f9;font-family: 'Open Sans',sans-serif;font-size: 13px;">
	<c:forEach items="${sessionScope.hospitaldata }" var="q" end="0">
	    <div class="navbar" style="padding-right: 14px;  background-color: white;     height: 69px;" >
			...
			<ul class="nav navbar-right col-md-9 col-sm-10 col-xs-8">
				<li class="dropdown"style="margin-left: 80%;">
					<a style="background-color: white;  color: #5f5f5f !important;   height: 49px;" data-toggle="dropdown" class="dropdown-toggle " href="javascript:;">
		...
		<ul class="nav nav-pills nav-stacked ullist" style="margin-top: -19px; height: 1695px; width: 217px;">
			<li ><a href="<%=request.getContextPath()%>/Admin?flag=desbord&id=${q.id }"><span class="icone"><img src="ing/dashboard.png"></span><span class="title">Dashboard</span></a></li>
			...
			<li><a href="<%=request.getContextPath()%>/OutPatient?flag=insert&id=${q.id }" class="left-tooltip" data-tooltip="Outpatient" title="Outpatient">
			...
			<li><a href="<%=request.getContextPath()%>/OperationManagement?flag=insert&id=${q.id }" class="left-tooltip" data-tooltip="Operation List" title="Operation List">
			<span class="icone"> <img src="ing/Operation-List-logo.png"></span><span class="title">Operation List</span></a></li>
			
			<li><a href="<%=request.getContextPath()%>/DiagnosisReport?flag=insert&id=${q.id }" class="left-tooltip" data-tooltip="Diagnosis" title="Diagnosis">
			...
			<span class="icone"> <img src="ing/Blood-Bank-logo.png"></span><span class="title">Blood Bank</span></a></li>
			
			<li><a href="" class="left-tooltip" data-tooltip="Appointment" title="Appointment">
			<span class="icone"> <img src="ing/Appointment-logo.png"></span><span class="title">Appointment</span></a></li>
			
			<li><a href="<%=request.getContextPath()%>/InvoiceManagement?flag=insert&id=${q.id }" class="left-tooltip" data-tooltip="Invoice" title="Invoice">
			<span class="icone"> <img src="ing/payment-logo.png"></span><span class="title">Invoice</span></a></li>
			
			<li><a href="<%=request.getContextPath()%>/Event?flag=insert&id=${q.id }" class="left-tooltip" data-tooltip="Event" title="Event">
			...
			<span class="icone"> <img src="ing/Ambulance-logo.png"></span><span class="title">Ambulance</span></a></li>
			<li><a href="<%=request.getContextPath()%>/InstrumentManagement?flag=insert&id=${q.id }" class="left-tooltip" data-tooltip="instrument" title="instrument">
			...
			<span class="icone"> <img src="ing/Report-logo.png"></span><span class="title">Report</span></a></li>
			<li><a href="" class="left-tooltip" data-tooltip="Account" title="Account"><span class="icone"> <img src="ing/account-logo.png"></span><span class="title">Account</span></a></li>
			<li><a href="<%=request.getContextPath()%>/ParsonRoll?flag=insert&id=${q.id }" class="left-tooltip" data-tooltip="Account" title="Account"><span class="icone"> <img src="ing/user.png"style="margin-top: -2px;height: 17px;"></span><span class="title">User Role</span></a></li>
		</ul>
	</c:forEach>
	...
	<!---start new dashboard------>
		<c:forEach items="${sessionScope.dashboarddata }" var="a" end="0">
				<div class="row">	
					...
					<div class="col-lg-2 col-md-2 col-xs-6 col-sm-3">
						<a href="<%=request.getContextPath()%>/Laboratory?flag=insert&id=${a.adminid.id }">
							<div class="panel info-box panel-white">
