...
<body style="background-color: #f1f4f9; font-family: 'Open Sans',sans-serif; font-size: 13px;">
	...
	<c:forEach items="${sessionScope.hospitaldata }" var="q" end="0"> 
		...
		<ul class="nav navbar-right col-md-9 col-sm-10 col-xs-8">
			<li class="dropdown"style="margin-left: 80%;">
				<a style="background-color: white; margin-top: 17px; height: 49px; color: #5f5f5f !important;"  data-toggle="dropdown" class="dropdown-toggle " href="javascript:;">
	...
	<div hidden="" id="message1" class="updated below-h2"style="width: 81%;margin-left: 253px;margin-top: 27px;"><p id="messagepass"></p></div>
		...
		<ul class="nav nav-pills nav-stacked ullist"style="margin-top: -20px; height: 1170;">
			...
			<li><a href="<%=request.getContextPath()%>/BedMenegement?flag=insert&id=${q.id }" class="left-tooltip" data-tooltip="Inpatient" title="Inpatient">
		...
		<div class="container" style="margin-right: 90px;">
			<ul class="nav nav-tabs tabcalss">
				<li class="active" id="tab1doctorlist"><a href="#home"
					data-toggle="tab" ><i class="fa fa-bars"
						aria-hidden="true" style="border-radius: 50%; padding: 8px;"></i>Accountant Staff List</a></li>
						
				<li id="tabdoctoradd"style="margin-left: 15px; background-color: f1f4f9;">
				<a href="#menu1" id="accountantStaffTab1" data-toggle="tab">
				<i class="fa fa-plus-circle"aria-hidden="true" style="border-radius: 50%; padding: 8px;"></i>Add New Accountant Staff</a>
				</li>
				<li id="tabdoctoradd"style="margin-left: 15px; background-color: f1f4f9;"><a 
				id="accountantStaffTab2" data-toggle="tab"
					href="#menu2" style="display: none;"><i class="fas fa-edit"
						aria-hidden="true" style="border-radius: 50%; padding: 8px;"></i>Edit Accountant Staff</a>
				</li>
			</ul>
			...
			<div id="home"  class="container tab-pane active"style="margin-top: 10px;">
			        ...
			        <thead>
			            <tr>
			                <th>Photo</th>
							 <th style="padding-left: 15px;">Accountant Name</th>
							 <th style="padding-left: 15px;"> Mobile Number</th>
							 <th style="padding-left: 15px;"> Accountant Email</th>
				...
				<div style="margin-top: 10px;">
				    <div class="form-group row">
			    	 ...
			    	 <div class="form-group row">
			    		...
			    		<input type="hidden" id="accountantStaffId" name="accountantStaffId" >
