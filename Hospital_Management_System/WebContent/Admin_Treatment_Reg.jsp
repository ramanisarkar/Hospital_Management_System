			...
			<div id="menu1" class="tab-pane">
				<form id="treatment_form" style="margin-top: 20px;" >
					...
					<div class="form-group row">
						...
						<div class="col-sm-8 ">
							<input type="number" class="form-control" name="treatment_price" placeholder="Treatment Name" min="0" step="0.01" onkeypress="if(this.value.length==10) return false;" required>
						</div>
					</div>
