...
public class PharmacistList {
	...
	private String firstname,midalname,lastname,date,gender,homeeaddrss,homecity,homestate,homecountry,
		...
		pharmacistupdate,pharmacisteemail,pharmacistuser,pharmacistemailinvalid,chackusername;
	...
	public String getPharmacistupdate() {
		return pharmacistupdate;
	}
	public void setPharmacistupdate(String pharmacistupdate) {
		this.pharmacistupdate = pharmacistupdate;
	}
	public String getPharmacisteemail() {
		return pharmacisteemail;
	}
	public void setPharmacisteemail(String pharmacisteemail) {
		this.pharmacisteemail = pharmacisteemail;
	}
	public String getPharmacistuser() {
		return pharmacistuser;
	}
	public void setPharmacistuser(String pharmacistuser) {
		this.pharmacistuser = pharmacistuser;
	}
	public String getPharmacistemailinvalid() {
		return pharmacistemailinvalid;
	}
	public void setPharmacistemailinvalid(String pharmacistemailinvalid) {
		this.pharmacistemailinvalid = pharmacistemailinvalid;
	}
