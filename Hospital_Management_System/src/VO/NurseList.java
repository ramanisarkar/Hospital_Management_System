...
public class NurseList {
	...
	public String getNurseemailinvalid() {
		return nurseemailinvalid;
	}
	public void setNurseemailinvalid(String nurseemailinvalid) {
		this.nurseemailinvalid = nurseemailinvalid;
	}
