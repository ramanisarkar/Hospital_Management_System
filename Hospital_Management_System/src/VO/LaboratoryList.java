...
public class LaboratoryList {
	...
	private String firstname,midalname,lastname,date,gender,homeeaddrss,homecity,homestate,homecountry,
		...
		laboratoryupdate,laboratoryemail,laboratoryuser,laboratoryemailinvalid,chackusername;
	...
	public String getLaboratoryupdate() {
		return laboratoryupdate;
	}
	public void setLaboratoryupdate(String laboratoryupdate) {
		this.laboratoryupdate = laboratoryupdate;
	}
	...
	public String getLaboratoryuser() {
		return laboratoryuser;
	}
	public void setLaboratoryuser(String laboratoryuser) {
		this.laboratoryuser = laboratoryuser;
	}
	public String getLaboratoryemailinvalid() {
		return laboratoryemailinvalid;
	}
	public void setLaboratoryemailinvalid(String laboratoryemailinvalid) {
		this.laboratoryemailinvalid = laboratoryemailinvalid;
	}
